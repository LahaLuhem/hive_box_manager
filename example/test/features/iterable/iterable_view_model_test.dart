...
void main() {
  ...
  Bdd(feature)
      ...
      .run((ctx) async {
        ...
        check(vm.tags.value).deepEquals(added);
      });
  ...
  Bdd(feature)
      ...
      .run((ctx) async {
        ...
        await vm.onRemovePressed(removed);

        check(vm.tags.value).deepEquals(remaining);
      });
  ...
  Bdd(feature)
      ...
      .run((ctx) async {
        ...
        vm.onKeySelected(otherList);
        check(vm.tags.value).isEmpty();

        vm.onKeySelected(homeList);
        check(vm.tags.value).deepEquals([tag]);
      });
}
