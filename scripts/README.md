...
Cuts a versioned release of `hive_box_manager`. Bumps the `version:` field in `pubspec.yaml`
...
> Unlike the maintainer's Flutter packages, `hive_box_manager` has no `example/pubspec.lock`
