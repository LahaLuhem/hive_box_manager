...
mixin _FakeBoxCore on Fake {
  ...
  bool get deleteEventsCarryValue;

  void ensureOpen() {
    if (closed) throw HiveError('Box has already been closed.');
  }
  ...
  Future<void> fakeDelete(Object? key) async {
    ...
    eventsController.add(BoxEvent(key, deleteEventsCarryValue ? oldValue : null, true));
  }
...
final class FakeEagerBox extends Fake with _FakeBoxCore implements Box<Object?> {
  ...
  @override
  bool get deleteEventsCarryValue => true;
...
final class FakeLazyBox extends Fake with _FakeBoxCore implements LazyBox<Object?> {
  ...
  @override
  bool get deleteEventsCarryValue => false;
