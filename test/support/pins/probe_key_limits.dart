/// Test-side companion to the library's key limits: re-exports `HiveKeyLimits` (one home, so the pins
/// and the gate cannot drift apart) and adds the probe-only sampling values that are not engine limits.
library;
...
abstract final class ProbeKeyLimits {
  ...
  /// failure is not specific to the exact boundary.
